The PROTECTED.csv files contain the raw simulated data of each zeolite configuration before being fitted to the Langmuir Isotherm model. The Template.csv file shows how the data is formatted.
