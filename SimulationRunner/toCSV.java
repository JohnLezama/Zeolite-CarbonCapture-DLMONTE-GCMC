...
import java.util.*;
public class toCSV{
    public static void toCSV(String zeo, String fileName, double[] ratios) throws IOException{
        Scanner sc; 
        sc = new Scanner(new File("C://users//aul12//Downloads//dlmonte_sims//"+zeo+"CorrectUnits.txt"));
        FileWriter output = new FileWriter("C://users//aul12//Downloads//dlmonte_sims//" + fileName);
        ...
        sc = new Scanner(new File("C://users//aul12//Downloads//dlmonte_sims//"+zeo+"N2CorrectUnits.txt"));
        while(sc.hasNextLine()){
            for(int i = 0; i<7; i++) sc.next();
