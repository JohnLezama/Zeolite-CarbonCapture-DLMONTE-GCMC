...
public class GeometryOptimization{
    public static void main(String[] args)throws IOException{
        Avogadro("FAU", 1.0, false);
    }
    
    static void Avogadro(String zeo, double ratio, boolean allSilica) throws IOException{
        double[] latticeDimensions = RemoveDuplicates.method(zeo+".xyz", zeo+"Fixed.xyz");
