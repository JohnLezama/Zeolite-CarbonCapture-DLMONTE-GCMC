...
public class RemoveDuplicates{
    ...
    static double[] method(String file, String outFile, String absoluteDirectory) throws IOException{
        Scanner sc = new Scanner(new File(absoluteDirectory+"Zeolites To Try//"+file));
