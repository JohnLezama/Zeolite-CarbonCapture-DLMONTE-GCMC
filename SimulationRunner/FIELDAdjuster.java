...
public class FIELDAdjuster{
    static void setFIELD(int numAtoms, String directory, String absoluteDirectory) throws Exception{
        Scanner sc;
        sc = new Scanner(new File(absoluteDirectory + "dlmonte_sims//"+directory+"//FIELD"));
        ...
        FileWriter output;
        output = new FileWriter(absoluteDirectory+"dlmonte_sims//"+directory+"//FIELD");
        for(String s: lines){
            output.append(s+"\n");
        }
        output.close();
